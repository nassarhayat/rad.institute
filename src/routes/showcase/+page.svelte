...
<h1>Showcase</h1>
<div class="feed">
  <a href="/showcase/hi-brandon" class="post showcase">
  ...
  <a href="/showcase/jumping-dogs" class="post showcase">
    <img src="/imgs/post-img2.jpg" alt="post-img" class="post-img" />
    <p class="tag">showcase</p>
    <h2>Lessons learned building an education programme for developers</h2>
  </a>
  <a href="/showcase/flying-cats" class="post showcase">
    <img src="/imgs/post-img3.jpg" alt="post-img" class="post-img" />
    <p class="tag">showcase</p>
    <h2>Lessons learned building an education programme for developers</h2>
  </a>
  <a href="/showcase/hello-mate" class="post showcase">
